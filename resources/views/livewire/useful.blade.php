    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12 my-2 d-flex justify-content-between">
                <a class="btn btn-primary create-btn" href="{{ route('useful.create') }}">
            ...
            <table class="table table-hover table-wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ Str::ucfirst($useful->users->name) }}</td>
                        <td class="d-flex">
                            <a class="btn btn-primary m-1" href="{{ route('useful.show', $useful->id) }}" title="View"
                            ...
                            <form method="POST" action="{{ route('useful.destroy', $useful->id) }}">
                                @csrf
